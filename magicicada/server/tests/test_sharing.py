...
class TestCreateShare(TestWithDatabase):
    ...
    def test_delete_volume(self):
        ...
        def create_share(_):
            share = self.usr1.root.share(self.usr0.id, "sharename",
                                         readonly=True)
    ...
    def test_notify_creation_to_myself_accepted_yes(self):
        ...
        def auth(client):
            ...
            d.addCallbacks(
                lambda _: client.create_share(
                    self._state.root_id, self.usr0.username, "acc Y",
                    Share.VIEW),
                client.test_fail)
    ...
    def test_notify_creation_to_myself_accepted_no(self):
        ...
        def auth(client):
            ...
            d.addCallbacks(
                lambda _: client.create_share(
                    self._state.root_id, self.usr0.username, "acc N",
                    Share.VIEW),
                client.test_fail)
        ...
        def make_share(_):
            ...
            d.addCallbacks(
                lambda _: client1.create_share(
                    self._state.root_id, self.usr1.username, "acc Y",
                    Share.VIEW),
                client1.test_fail)
    ...
    def test_notify_creation_bad(self):
        ...
        def auth(client):
            ...
            d.addCallbacks(
                lambda _: client.create_share(
                    self._state.root_id, self.usr1.username, "name",
                    Share.VIEW),
                client.test_fail)
...
class TestListShares(TestWithDatabase):
    ...
    def test_share_offer(self):
        ...
        def createShareOffer():
            # test a share offer
            self.usr0.root.make_shareoffer("me@example.com", "share Offer",
                                           readonly=True)
    ...
    def test_dead_share(self):
        ...
        def createShare():
            share = self.usr1.root.share(self.usr0.id,
                                         "another dead share", readonly=True)
            share.delete()
