...
from magicicada.txlog import utils
from magicicada.txlog.models import DBWorkerLastRow, TransactionLog
from magicicada.txlog.tests.test_models import BaseTransactionLogTestCase
...
class TransactionLogUtilsTestCase(BaseTransactionLogTestCase):
    ...
    def test_deletes_old_txlogs_within_quantity_limit(self):
        ...
        removed = utils.delete_old_txlogs(
            timestamp_limit=timestamp_limit, quantity_limit=quantity_limit
        )
    ...
    def test_deletes_txlogs_slice(self):
        ...
        removed = utils.delete_txlogs_slice(
            date=right_now.date(), quantity_limit=quantity_limit
        )
        self.assertEqual(removed, quantity_limit)
