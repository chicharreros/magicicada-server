...
class HeartbeatListenerTestCase(BaseTestCase):
    ...
    def setUp(self):
        ...
        self.rpc = mock.Mock()
        self.listener = HeartbeatListener(
            1,
            10,
            ['foo'],
            [],
    ...
    def test_handle_heartbeat(self):
        ...
        self.listener.handle_heartbeat(
            'process_name', 'group_name', '42', payload
        )
        info = {
            "pid": "42",
            "time": payload["time"],
    ...
    def test_handle_event(self):
        ...
        self.assertEqual(
            ["READY", "RESULT 2", "OK"], self.stdout.getvalue().split("\n")
        )
    ...
    def test_invalid_payload(self):
        ...
        payload_dict = {"time": time.time(), "type": "ping"}
        raw_data = (
            'processname:ticker groupname:ticker pid:42\n'
    ...
    def test_unhandled_event(self):
        ...
        raw_header = (
            "ver:3.0 server:supervisor serial:1 pool:heartbeat "
