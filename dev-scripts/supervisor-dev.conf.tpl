...
environment=PYTHONPATH="%(basepath)s/lib",DJANGO_SETTINGS_MODULE="filesync.settings",PROTOCOL_BUFFERS_PYTHON_IMPLEMENTATION=cpp,CONFIG="%(basepath)s/configs/development.yaml"
...
environment=PYTHONPATH="%(basepath)s/lib",DJANGO_SETTINGS_MODULE="filesync.settings",CONFIG="%(basepath)s/configs/development.yaml"
stdout_capture_maxbytes=16384
autostart=false
stopsignal=INT
