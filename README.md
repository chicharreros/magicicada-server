...
The just generated 'privkey.pem' and 'cacert.pem' will be used
...
(with this django command you'll be able to also retrieve and update
...
Following the folder structure we started above, branch the client and
